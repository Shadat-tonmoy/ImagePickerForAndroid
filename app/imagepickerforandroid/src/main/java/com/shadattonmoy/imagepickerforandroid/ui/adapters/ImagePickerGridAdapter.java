...
public class ImagePickerGridAdapter extends BaseAdapter
{
    ...
    {
        ArrayList<String> selectedImages = (ArrayList<String>) bundle.getSerializable(Tags.SELECTED_IMAGES);
        HashMap<Integer, Boolean> selectedPositions = (HashMap<Integer, Boolean>) bundle.getSerializable(Tags.SELECTED_IMAGES_POSITIONS);
        HashMap<Integer, Integer> selectionIds = (HashMap<Integer, Integer>) bundle.getSerializable(Tags.SELECTED_IMAGES_IDS);
